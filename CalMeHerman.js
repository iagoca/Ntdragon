...
petik = '```'
fake = 'NTDRAGONBOT'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝕾𝖎𝖑𝖆𝖍𝖐𝖆𝖓 𝕻𝖎𝖑𝖎𝖍 𝕯𝖎𝖘𝖓𝖎!","footerText": "tmj maninhos e maninhas❤️","listType": "SINGLE_SELECT","sections": list}}, {})
...
dha.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
        ...
        menu =`༒ *INFO USER* ༒
ᱝ *Nome :* ${pushname}
ᱝ *Nomero :* @${sender.split('@')[0]}
ᱝ *Status :* ${isOwner ? 'OWNER' : isPremium ? 'Premium' : 'Nao detctado'}
ᱝ *🔋 :* ${baterai}% 
...
༒ *INFO TODAY* ༒
ᱝ *Hora :* ${moment().utcOffset('+0700').format('HH:mm')}
ᱝ *Data :* ${moment.tz('Asia/Jakarta').format('DD/MM')}
ᱝ *User :* ${pushname}
`
               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: 'SEMUAH FITUR😈'},type:1},{buttonId: `${prefix}vn`,buttonText:{displayText: 'MENU VN🗣️'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: 'Iago o brabo do momento', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
        ...
        case 'command':
               ...
               listmsg(from, `${ucapanWaktu}`,  `oi ${pushname}\nao se esqueça de comer🤡`, list)
               break
       case 'othercmd':
               list = []
               listmenu = [`ruleswave`]
...
*き⃟🦈️ ${prefix}efix* _teks_
*き⃟🦈 ${prefix}tor* _audio_
*き⃟🦈 ${prefix}term*
*き⃟🦈 ${prefix}eval*
*き⃟🦈 ${prefix}clearall*
*き⃟🦈 ${prefix}leaveall*
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1},{buttonId:`${prefix}nhentaibot`,buttonText:{displayText:'NHENTAI BOT'},type:1}]
              ...
              buttonsMessage = {footerText:'Escolha por qual mídia vc quer baixar', imageMessage: imageMsg,
...
break
       ...
       case 'wallml':
              ...
              buttonsMessage = {footerText:'vc quer uma imagem de:', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
              prep = await dha.prepareMessageFromContent(from,{buttonsMessage},{quoted: mek})
              dha.relayWAMessage(prep)
              fs.unlinkSync(`./${sender}.jpeg`)
...
*[Wait] Tunggu Sebentar..*`
              ...
              buttonsMessage = {footerText:'Nao se esqueça de doar irmão ☕', imageMessage: imageMsg,
              contentText:`Selecione a midia que vc deseja baixar!`,buttons,headerType:4}
              prep = await dha.prepareMessageFromContent(from,{buttonsMessage},{quoted: mek})
              dha.relayWAMessage(prep)
              break
          case 'lirik':
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Siga me :\n https://instagram.com/iago_cardoso__?utm_medium`)
             break
      case 'grupbot':
